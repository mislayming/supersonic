...
public class S2TvChannelDemo extends S2BaseDemo {
    ...
    public ModelResp addTvChannelModel(DomainResp domain, DatabaseResp database) throws Exception {
        ...
        dimensions.add(new Dimension("PixelAspectRatio", "Pixel_aspect_ratio_PAR",
                DimensionType.categorical, 1));
        dimensions.add(new Dimension("HighDefinitionTV", "Hight_definition_TV",
                DimensionType.categorical, 1));
        dimensions
                .add(new Dimension("PayPerView", "Pay_per_view_PPV", DimensionType.categorical, 1));
        dimensions.add(
    ...
    public ModelResp addCartoonModel(DomainResp domain, DatabaseResp database) throws Exception {
        ...
        dimensions
                .add(new Dimension("OriginalAirDate", "Original_air_date", DimensionType.time, 1));
        dimensions.add(
                new Dimension("ProductionCode", "Production_code", DimensionType.categorical, 1));
    ...
    public ModelResp addTvSeriesModel(DomainResp domain, DatabaseResp database) throws Exception {
        ...
        dimensions.add(new Dimension("18-49 Rating Share", "18_49_Rating_Share",
                DimensionType.categorical, 1));
    ...
    private Agent addAgent(Long dataSetId) {
        ...
        agent.setExamples(Lists.newArrayList("All cartoon shows on a specific channel",
                "Top three TV series by rating", "What English language channels are available",
                "Who directed a specific cartoon"));
