...
from build_tvshow_models import build, get_authorization
...
def get_pred_result():
    ...
    input_path = current_directory + "/data/tvshow.txt"
    pred_sql_path = current_directory + "/data/pred_example_tvshow.txt"
    ...
    time_cost = []
    #time.sleep(60) 估计是等待服务器执行 dimvalue & emmbedding 创建等。。。
