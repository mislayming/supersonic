...
def build_dataSet(domain_id, model_id1, model_id2, model_id3, model_id4):
    ...
    json_dict = {"name": "DuSQL 互联网企业", "bizName": "internet",
                 ...
                 "typeEnum": "VIEW", "sensitiveLevel": 0, "domainId": domain_id, "viewDetail":
                     {"viewModelConfigs": [{"id": model_id1, "includesAll": False, "metrics": metric_list1,
                                            "dimensions": dimension_list1}, {"id": model_id2, "includesAll": False,
                                                                             ...
                                                                             "dimensions": dimension_list2},
                                           {"id": model_id3, "includesAll": False, "metrics": metric_list3,
                                            "dimensions": dimension_list3},
                                           {"id": model_id4, "includesAll": False, "metrics": metric_list4,
                                            "dimensions": dimension_list4}]}, "queryConfig": {"detailTypeDefaultConfig":
                                                                                                  {"dimensionIds": [],
                                                                                                   "metricIds": []},
    ...
    json_dict = {"name": "DuSQL 互联网企业", "bizName": "internet",
                 "description": "DuSQL互联网企业数据源相关的指标和维度等", "typeEnum": "DATASET", "sensitiveLevel": 0,
                 "domainId": domain_id,
                 ...
                 "queryConfig": {"detailTypeDefaultConfig": {}, "aggregateTypeDefaultConfig": {
                     "timeDefaultConfig": {"unit": 0, "period": "DAY", "timeMode": "RECENT"}}}, "admins": ["admin"],
                 "admin": "admin"}
